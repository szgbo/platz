...
const getTransform = (pos, center, zoom) => {
...
const initCursorChat = (room_id, getCanvasCenterX, getCanvasCenterY, getCanvasZoom, triggerKey = "/", cursorDivId = "cursor-chat-layer", chatDivId = "cursor-chat-box") => {
  ...
  const cursor_map = /* @__PURE__ */ new Map();
      ...
      if (cursor_id !== me.id) {
        switch (change.action) {
          case "add":
            ...
            console.log("add")
            cursor_map.set(cursor_id, {
              elem: null,
              x: new_cursor.x,
              y: new_cursor.y,
              perfect_cursor: perfect_cursor
            });
            break;
          case "update":
  ...
  return {cleanup, handleInfiniteCanvasMove};
};
